...
object FabricHierophanticsVillagers {
    ...
    val FLAY_BED_POI = PointOfInterestHelper.register(FLAY_BED_ID, 1, 1, Hierophantics.FLAY_BED_BLOCK.get()
    ...
    val QUILTMIND_POI = PointOfInterestHelper.register(QUILTMIND_ID, 1, 1, Hierophantics.EDIFIED_WORKSTATION_BLOCK.get())
