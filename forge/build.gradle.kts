...
loom {
    forge {
        ...
        mixinConfig(
            "hierophantics-common.mixins.json",
            "hierophantics-forge.mixins.json",
        )
    }
    ...
    runs {
        register("commonDatagen") {
            ...
            property("hierophantics.apply-datagen-mixin", "true")
        }
    }
}

hierophanticsModDependencies {
