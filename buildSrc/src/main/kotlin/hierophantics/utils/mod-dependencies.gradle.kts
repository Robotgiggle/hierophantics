...
abstract class HierophanticsModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<HierophanticsModDependenciesExtension>("hierophanticsModDependencies")
